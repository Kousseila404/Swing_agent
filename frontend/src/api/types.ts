...
export interface paths {
    ...
    "/api/my_portfolio": {
        ...
        /** Get My Portfolio */
        get: operations["get_my_portfolio_api_my_portfolio_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/performance/benchmark": {
         ...
         * @description Compte réel (Alpaca) vs SPY vs panier TITAN top-N théorique, rebasés à 100.
         *
         ...
         */
        get: operations["get_performance_benchmark_api_performance_benchmark_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/portfolio/protection": {
        ...
        /**
         * Get Portfolio Protection
         * @description État de protection (stop broker) de chaque position OPEN. Cache 60 s.
         */
        get: operations["get_portfolio_protection_api_portfolio_protection_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/system/health": {
        ...
        /**
         * Get System Health
         * @description Vue « tout va bien ? » : tracker (heartbeat), killswitch, circuit breaker,
    ...
    "/api/scoring/lab": {
        ...
        /**
         * Get Scoring Lab
         * @description Edge du scoring sur la fenêtre live (paniers, piliers seuls, profils de
         *     poids) — lecture de `data/.scoring_lab.json` produit par
         *     `python -m modules.scoring_lab` (run_titan.sh). 404 si jamais calculé.
         */
        get: operations["get_scoring_lab_api_scoring_lab_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/shadow": {
        ...
        /**
         * Get Shadow
         * @description Forward-test A/B : NAV des portefeuilles virtuels par profil de scoring.
         */
        get: operations["get_shadow_api_shadow_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/performance/gap": {
        ...
        /**
         * Get Performance Gap
         * @description Attribution de l'écart compte vs panier : cash drag, slippage, stops, sélection.
         */
        get: operations["get_performance_gap_api_performance_gap_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/rebalance/preview": {
         ...
         * @description Ordres de rebalance 1/N qui seraient passés (lecture seule).
         */
        get: operations["get_rebalance_preview_api_rebalance_preview_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    get_my_portfolio_api_my_portfolio_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_performance_benchmark_api_performance_benchmark_get: {
        parameters: {
            query?: {
                months?: number;
                top_n?: number;
    ...
    get_portfolio_protection_api_portfolio_protection_get: {
        parameters: {
            query?: {
                refresh?: boolean;
            };
    ...
    get_scoring_lab_api_scoring_lab_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_performance_gap_api_performance_gap_get: {
        parameters: {
            query?: {
                months?: number;
                top_n?: number;
    ...
    get_rebalance_preview_api_rebalance_preview_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
